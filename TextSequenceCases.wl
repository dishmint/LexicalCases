...
WikipediaArticlesFromRule[rule:("Category" -> _), opts:OptionsPatten[]]:= WikipediaSearch[rule,"CategoryArticles", Sequence@@FilterRules[{opts}, OptionsJoin[WikipediaSearch,TextSequenceCasesWikipedia]]]
