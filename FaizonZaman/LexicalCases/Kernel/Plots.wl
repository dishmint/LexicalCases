...
FaizonZaman`LexicalCases`LexicalDispersionPlot[text_String, word_String, opts:OptionsPattern[{FaizonZaman`LexicalCases`LexicalDispersionPlot}]] := FaizonZaman`LexicalCases`LexicalDispersionPlot[text, {word}, opts]
FaizonZaman`LexicalCases`LexicalDispersionPlot[text_String, words:{__String}, opts:OptionsPattern[{FaizonZaman`LexicalCases`LexicalDispersionPlot}]] := Module[
	{
		tokens = Monitor[
